...
HD_PWD='D:/vivado projects/JZ_project_1/JZ_project_1/JZ_project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_32bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source alu_32bit.tcl
